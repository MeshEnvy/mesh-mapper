...
Options:
  --lora-preset {Long-Fast,Long-Moderate,Long-Slow,Medium-Fast,Medium-Slow,Short-Fast}
                        LoRa preset to use (default: Long-Fast)
...
**Use Long-Slow preset with 90m resolution:**
```bash
python meshtastic_coverage_mapper.py nodes.csv --lora-preset Long-Slow --resolution 90
```
...
Reno_Peak,39.5296,-119.8138,8200
Virginia_City,39.3097,-119.6505,6500
Mount_Rose,39.3436,-119.9122,10776
```
...
The script includes the following Meshtastic LoRa presets:

| Preset | SF | BW (kHz) | RX Sensitivity | Typical Range |
|--------|----|---------:|---------------:|--------------:|
| Long-Fast | 11 | 250 | -134 dBm | 15-30 mi |
| Long-Moderate | 11 | 125 | -137 dBm | 20-35 mi |
| Long-Slow | 12 | 125 | -140 dBm | 25-40 mi |
| Medium-Fast | 10 | 250 | -131 dBm | 10-20 mi |
| Medium-Slow | 11 | 125 | -137 dBm | 15-25 mi |
| Short-Fast | 7 | 250 | -123 dBm | 5-10 mi |

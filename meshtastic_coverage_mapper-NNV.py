...
def generate_private_map(nodes_df: pd.DataFrame, coverage_data: Dict, 
    ...
    colors = ['none', '#00CC00', '#FFFF00', '#FF8800', '#FF0000', '#CC0000', '#8800CC']
...
def main():
    ...
    # Large buffer to cover northern Nevada (from Tonopah north to Oregon border)
    lat_buffer = 2.0  # degrees (~140 miles) - covers Tonopah to Oregon
    lon_buffer = 2.0  # degrees (~140 miles) - covers width of northern Nevada
